...
\begin{center}
  ...
  \href{mailto:asmacdo@gmail.com}{asmacdo@gmail.com} \enspace$\bullet$\enspace (336) 687-0315 \enspace$\bullet$\enspace Rock Island, IL 61201 \enspace$\bullet$\enspace \href{https://github.com/asmacdo}{github.com/asmacdo}
\end{center}

% -- Summary --
\section{Summary}

Research software engineer focused on software architecture, reproducibility, provenance, and automation for complex data and computational workflows. Turns ambiguous research problems into usable, maintainable systems across open science platforms, distributed systems, and developer tooling. Consensus builder across researchers, engineers, and stakeholders. Fully remote since 2016. Deeply integrated AI workflows---from design partner for architecture and planning to autonomous agents for well-scoped work.

% -- Professional Experience --
\section{Professional Experience}

\subsection{Research Software Engineer}
\hfill\textnormal{\small2022--Present}\\
\textbf{Dartmouth College -- Center for Open Neuroscience}
\begin{itemize}
...
\subsection{Software Engineer -- Operator-SDK \& OpenShift}
...
\subsection{Software Engineer -- Pulp Project}
...
\subsection{Developer Intern}
\hfill\textnormal{\small2014}\\
\textbf{Center for Open Science}
\begin{itemize}
...
\begin{itemize}
  \item \textbf{KubeCon 2023:} Essential Patterns For Designing And Implementing Your Operator
  \item \textbf{SciPy 2018:} Reproducible Environments for Reproducible Results
